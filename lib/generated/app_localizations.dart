...
abstract class AppLocalizations {
  ...
  /// No description provided for @twoPerRow.
  ///
  /// In en, this message translates to:
  /// **'2 per row'**
  String get twoPerRow;

  /// No description provided for @threePerRow.
  ///
  /// In en, this message translates to:
  /// **'3 per row'**
  String get threePerRow;

  /// No description provided for @fourPerRow.
  ///
  /// In en, this message translates to:
  /// **'4 per row'**
  String get fourPerRow;
